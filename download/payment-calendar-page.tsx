...
import {
  ...
  FileText, Send, ShieldCheck, X, Save, RotateCcw, CalendarDays, Loader2, Ban, CalendarRange,
} from "lucide-react";
import { cn } from "@/lib/utils";
import { countRussianWorkingDays, isRussianWorkingDay } from "@/lib/russian-calendar";
import ProductionCalendarTab from "./ProductionCalendarTab";
import {
  Select,
  SelectContent,
  SelectGroup,
...
export default function PaymentCalendarPage() {
  ...
  // Tab switching (admin only for production calendar)
  const [activeTab, setActiveTab] = useState<"calendar" | "production">("calendar");
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Tab buttons */}
      {isAdmin && (
        <div className="px-6 pt-3 pb-0 flex items-center gap-1 border-b border-gray-200 bg-white shrink-0">
          <button
